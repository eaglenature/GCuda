...
//                                                             //
//-------------------------------------------------------------//
TEST(HostVectorEqual, StdVectorInt)
{
    typedef int T;
...
TEST(HostVectorEqual, ThrustVectorInt2)
{
    typedef int2 T;
    const int numElements = 10;
